...
echo ""
echo "Note: The Internal dashboard requires an ADMIN or ENGINEER role."
echo "To get your email hash for ADMIN_EMAIL_HASHES in .env:"
echo "  ./scripts/get-email-hash.sh <your-email>"
echo ""
echo "If you are already logged in and redirected, use your Supabase Auth ID to promote your user:"
echo "  ./scripts/promote-user.sh <your-auth-id>"
echo ""
...
echo ""
echo "To test frontend production build locally:"
echo "  pnpm run test:frontend-deployment"
echo ""
