...
_Note: Your devices will have names like `studio-1.tailxxxxx.ts.net` or `macbook-pro.tailxxxxx.ts.net`._
...
- Check that the node reappears as "Online" in the Tailscale Admin Console and can be pinged _before_ you log into the macOS GUI.
