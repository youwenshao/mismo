    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="hidden w-64 shrink-0 flex-col bg-gray-900 text-white md:flex">
        ...
        <div className="flex items-center gap-2 border-b border-white/10 px-6 py-5">
          <span className="text-xl font-bold tracking-tight">Mismo</span>
        ...
        <div className="border-t border-white/10 px-6 py-4">
          <p className="text-xs text-gray-500">Mismo Platform v0.1</p>
        </div>
      </aside>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6 dark:border-gray-800 dark:bg-gray-950">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-indigo-100 text-sm font-medium text-indigo-600 dark:bg-indigo-900/50 dark:text-indigo-400">
            E
          </div>
        </header>
